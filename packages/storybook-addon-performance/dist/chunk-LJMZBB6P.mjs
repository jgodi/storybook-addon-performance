...
var LazySyntaxHighlighter = lazy(() => import("./syntaxhighlighter-3EX6JOZ7-OU2STJW5.mjs"));
var LazySyntaxHighlighterWithFormatter = lazy(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-3EX6JOZ7-OU2STJW5.mjs"), import("./formatter-PK6264PW-EHEKKPI3.mjs")]);
...
var LazyWithTooltip = lazy2(() => import("./WithTooltip-52JYBAXX-LTQSGBSQ.mjs").then((mod) => ({ default: mod.WithTooltip })));
var LazyWithTooltipPure = lazy2(() => import("./WithTooltip-52JYBAXX-LTQSGBSQ.mjs").then((mod) => ({ default: mod.WithTooltipPure })));
